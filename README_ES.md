...
- **Control remoto + diapositivas**: el control remoto del presentador no funciona correctamente con slides que no son preguntas (`comment`, `info`, actividad libre). Los botones de acción quedan en un estado incorrecto.
